  ...
  return (
    <main className='flex flex-nowrap flex-col items-center px-0 py-0 w-full bg-black'>
      ...
      {/* <div className='relative w-full h-screen'>
        <img
          src="https://bumblebuzz.s3.us-east-1.amazonaws.com/demo/art6.jpg"
          className="object-cover w-full h-screen"
          alt="Image alt text"
        />
        <div className='top-0'>asdasd</div>
      </div> */}
      {/* <div
        className='w-full h-screen'
        style={{backgroundImage: "url('https://bumblebuzz.s3.us-east-1.amazonaws.com/demo/art6.jpg')"}}
        >
        asdasdasdasd
      </div> */}
      ...
      {/* about us */}
      <div className='pt-28 pb-2 w-full h-fit bg-gray-700 flex flex-col flex-wrap items-center text-center justify-center gap-4'>
      ...
      <div className='pt-28 pb-2 w-full h-fit bg-gray-700 flex flex-col flex-wrap items-center text-center justify-center gap-4'>
        ...
        <div className='flex flex-row flex-wrap items-end text-center justify-evenly w-full gap-4'>
          ...
          <div className='flex flex-col flex-wrap max-w-2xl'>
            ...
            <p className='text-white'>There are many ways to collect commission on BumbleBuzz. This is to help creators earn rewards for their hard work.</p>
            <p className='text-white'>Given a successful sale, the commission comes from the final sale price and is distributed amongst the creators.</p>
            <br />
            <div className='flex flex-row flex-wrap items-center text-center justify-center w-full gap-4'>
              <div className={`max-w-xs ${COMMISSION_TEXT_STYLE}`}>
                <p className='h-fit sm:h-40'>
        ...
        <div className='flex flex-row flex-wrap items-end text-center justify-evenly w-full gap-4'>
          <div className='flex flex-col flex-wrap max-w-2xl'>
            ...
            <p className='text-white'>BubbleBuzz allows creators and collectors to receive incentives to help users grow.</p>
            <p className='text-white'>There are two types of incentives: marketplace incentives and collection-specific incentives.</p>
            <br />
            <div className='flex flex-row flex-wrap items-center text-center justify-center w-full gap-4'>
